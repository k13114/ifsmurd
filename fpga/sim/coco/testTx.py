...
async def first_value_test(dut):
    ...
    await Timer(90, units=unitsOfTime)
    dut.startTx.value = 0b1  # modulationIndex = 1
    await Timer(90, units=unitsOfTime)
    dut.startTx.value = 0b0  # modulationIndex = 1
...
#    dut.modulationIndex.value = 0b00000000000000000_111100110011001  # modulationIndex = 0.95
#    dut.rstIn.value = 1
#    dut.F20.value = 0b11111111111111111_100000000000000  # -1/2
#    await Timer(90, units=unitsOfTime)
#    dut.rstIn.value = 0
#
#    await Timer(90, units=unitsOfTime)
#    dut.enableIn.value = 1
#    await Timer(90, units=unitsOfTime)
#    dut.enableIn.value = 0
#
#    simTime = 2*20000
#    await Timer(simTime, units=unitsOfTime)
...
def test_simple_dff_runner():
    ...
    hdlTopLevelInput = "uartTx"
    testModuleInput = "testTx"
